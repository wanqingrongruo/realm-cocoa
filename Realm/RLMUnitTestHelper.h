...
/**
 ...
 Each test's Realms are completely isolated from the Realms of other tests. The state of the underlying bindings will
 automatically be reset after each test. Obtain this special Realm for test use simply by calling `[RLMRealm realm]`.
 You may also obtain Realms with other configurations explicitly, as usual.
...
/**
 Creates an instance of the unit test helper.
...
/**
 Dispatches an asynchronous block on the test-specific dispatch queue, and wait for the block to complete executing
 before returning. Prefer this method to using GCD directly.
 */
